...
class DiscoverFreshItemScreen extends StatefulWidget {
  @override
  _DiscoverFreshItemScreenState createState() =>
      _DiscoverFreshItemScreenState();
}

class _DiscoverFreshItemScreenState extends State<DiscoverFreshItemScreen> {
